        ...
        <aside className="w-80 p-6 h-screen sticky top-0 z-50">
            <div className="h-full w-full glass-sidebar rounded-[40px] flex flex-col p-6 transition-all duration-500">
                ...
                <div className="flex items-center space-x-4 mb-12 px-2 mt-2">
                    ...
                    <div>
                        <h1 className="font-display font-black text-2xl text-clay-foreground tracking-tight leading-none">Antigravity</h1>
                        <p className="text-xs text-clay-muted font-bold uppercase tracking-widest mt-1 opacity-60">Cockpit v1.2</p>
                    </div>
                </div>
                ...
                <nav className="space-y-3 flex-1">
                    ...
                    <NavItem icon={<Rocket />} label="Action Plan" />
                    <NavItem icon={<Layers />} label="System Logic" />
                </nav>
                ...
                <div className="mt-auto pt-6 border-t border-clay-accent/5">
                     <div className="bg-white/50 rounded-2xl p-4 flex items-center justify-between">
                         <div className="flex items-center space-x-3">
                            ...
                            <span className="text-sm font-bold text-clay-foreground/80">System Active</span>
                         </div>
                         <div className="text-[10px] font-black text-clay-accent px-2 py-1 bg-clay-accent/10 rounded-lg">LIVE</div>
                     </div>
                </div>
            </div>
        </aside>
...
const NavItem = ({ icon, label, active = false }: { icon: React.ReactNode, label: string, active?: boolean }) => (
    <div className={clsx(
        ...
        <div className={clsx(
            ...
            active ? "bg-clay-accent/10 scale-110" : "bg-transparent group-hover:bg-clay-accent/5 group-hover:scale-110"
        )}>
