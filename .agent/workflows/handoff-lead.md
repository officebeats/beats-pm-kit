...
1. **Prepare/Stage Request**
   - **Direct Path**: If a [Feature Plan](file:///[redacted-user-home]/Documents/GitHub/switchboard/.switchboard/plans/features/) already exists and is approved, you may SKIP creating a new request file.
