...
- Do not read Slack, Teams, Outlook, Calendar, Jira, or Confluence unless the user provides an explicit bounded scope and invokes the relevant communication workflow.
...
3. If the packet reports missing scopes, ask for the bounded scope or continue from local files only.
