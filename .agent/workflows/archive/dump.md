...
| :--- | :--- | :--- | :--- | :--- |
| **Task** | [a former employer] | TASK_MASTER | Fix login issue | P1 |
| **Bug** | [a former employer] | bugs-master | Error 500 on checkout | P0 |
| **Boss** | [a former employer] | boss-requests | Review Q3 deck | **P0** |
