...
description: Execute the full Centrifuge Protocol to keep the brain lean, private, and organized. Use as the cleanup engine behind the kit maintenance workflow when the user requests system optimization, task archiving, or hierarchical integrity auditing. Do NOT use to archive active code or configurations.
---

> **Compatibility Directive**: This component is optimized primarily for the Google Antigravity runtime, but gracefully degrades to support Gemini CLI, Claude Code, and Kilocode CLI.

# Centrifuge Protocol Skill
...
The public maintenance entrypoint is `.agent/workflows/vacuum.md`. This skill provides the deeper cleanup and privacy-audit behavior for that workflow; it is not a separate slash-command surface.
