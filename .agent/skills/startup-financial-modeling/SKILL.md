...
description: AI finance team for startup financial modeling, investment analysis, and projections.
---

# AI Finance Agent Team

**AI finance team for startup financial modeling, investment analysis, and projections.**

This skill leverages an advanced Python-based AI Agent or Multi-Agent Team located in the `scripts/` directory.

## Instructions
1. Use this skill whenever the user triggers the associated playbook or asks for startup-financial-modeling.
