...
1. **Market Context**: Load company profile from `1. Company/the company-Health-Profile.md`. Focus deeply on the Payer-Provider ecosystem and the pivot to commercial AI platforms.
2. **Analysis**: Apply frameworks as appropriate. Evaluate decisions against: "How does this defend against InterQual? How does this align with the company's 30th Edition architecture?"
