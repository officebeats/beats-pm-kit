...
description: AI consulting agent providing startup analysis, competitive research, and business strategy.
---

# AI Consultant Agent

**AI consulting agent providing startup analysis, competitive research, and business strategy.**

This skill leverages an advanced Python-based AI Agent or Multi-Agent Team located in the `scripts/` directory.

## Instructions
1. Use this skill whenever the user triggers the associated playbook or asks for startup-analyst.
