...
NEW_TASK_TERMS = [
    ...
    "to do",
    "action item",
    # These overlap with TASK_UPDATE_TERMS intentionally: explicit task IDs or
    # task wording route first as updates, while standalone follow-ups become
    # candidate new tasks that still require the Priority Gate.
    "follow up",
    "follow-up",
    "need to",
    "needs to",
