...
PY_COMPILE_FILES = [
    ...
    "system/scripts/markdown_intake.py",
    "system/scripts/markdown_humanizer.py",
    ...
    "system/tests/test_action_first_output.py",
    "system/tests/test_markdown_intake.py",
    "system/tests/test_markdown_humanizer.py",
...
TEST_MODULES = [
    ...
    "system.tests.test_action_first_output",
    "system.tests.test_markdown_intake",
    "system.tests.test_markdown_humanizer",
