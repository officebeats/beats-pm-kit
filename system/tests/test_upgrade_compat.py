...
class TestUpgradeCompatibility(unittest.TestCase):
    ...
    def test_safe_migration_adds_titles_without_renaming_or_breaking_links(self):
        root = self.make_root()
        task = root / "5. Trackers" / "tasks" / "PARU-014.md"
        original = "# PARU-014 — Review recommendation work\n\n> **Status:** Active\n"
        ...
        task_master.write_text(
            ...
            "| [PARU-014](tasks/PARU-014.md) | Review recommendation work | Owner | TBD | Active |\n",
            encoding="utf-8",
        )

        report = upgrade_compat.inspect(root)
        self.assertFalse(report.blockers)
        self.assertEqual({item.path for item in report.changes}, {"5. Trackers/TASK_MASTER.md", "5. Trackers/tasks/PARU-014.md"})
        ...
        self.assertIn("tasks/PARU-014.md", task_master.read_text(encoding="utf-8"))
    ...
    def test_id_only_task_uses_existing_task_master_label_without_renaming(self):
        ...
        task_master.write_text(
            "# Task Master\n\n| ID | Task | Owner | Due | Status |\n|:---|:---|:---|:---|:---|\n"
            "| [PARU-014](tasks/PARU-014.md) | **Review recommendation work** — Follow up | Owner | TBD | Active |\n",
            encoding="utf-8",
        )
        ...
        self.assertFalse(report.blockers)
        task_change = next(change for change in report.changes if change.path.endswith("PARU-014.md"))
