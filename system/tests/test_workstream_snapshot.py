    ...
    def test_real_workstream_rows_render_first(self):
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            (tracker / "WORKSTREAMS.md").write_text(
                ...
                "|:-----------|:---------------|:------------------|:-----------|:-------------------|:-------|\n"
                "| Synapse API partner routing | 2026-06-28: decision rule drafted | None newly confirmed | 1 Slack ask | Confirm owner; draft outcome; update tracker | Active |\n",
                encoding="utf-8",
            )
            ...
            self.assertIn("### Synapse API partner routing", rendered)
    ...
    def test_task_master_fallback_strips_internal_ids_from_titles(self):
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            (tracker / "TASK_MASTER.md").write_text(
                ...
                "|:---|:-----|:------|:----|:-------|\n"
                "| [PARU-048](tasks/PARU-048.md) | **Define exception intake checklist** — Build checklist | Owner | 2026-06-29 | Partner wants checklist |\n",
                encoding="utf-8",
            )
            (critical / "boss-requests.md").write_text(
                "| ID | Date | Task | Source |\n"
                "|:---|:-----|:-----|:-------|\n"
                "| BOSS-001 | 2026-05-07 | Define user stories for Synapse API sandbox tracking \"Re: old subject\" | boss |\n",
                encoding="utf-8",
            )
            ...
            self.assertIn("### Define user stories for Synapse API sandbox tracking", rendered)
            self.assertNotIn("### PARU-048", rendered)
            self.assertNotIn("### BOSS-001", rendered)
            self.assertNotIn("Re: old subject", rendered)
            self.assertNotIn("Evidence: PARU-048", rendered)
