        ...
        (root / "5. Trackers" / "TASK_MASTER.md").write_text(
            "\n".join(
                [
                    ...
                    "|:---|:-----|:------|:----|:-------|",
                    "| [PLAN-014](tasks/PLAN-014.md) | **Review DS Guideline Recommendation work** — GLR ramp | OfficeBeats | 2026-05-13 | 🔴 Active — GLR production target needs context |",
                ]
            ),
            encoding="utf-8",
        )
    ...
    def test_updates_existing_task_and_preserves_raw_evidence(self):
        ...
        raw = "\n".join(
            [
                "Abbey Armstead",
                "OfficeBeats 2:00 PM",
                "Manager said OfficeBeats will set-up some time to talk to you about guideline/tenant specific configuration.",
                "Abbey 3:30 PM",
        ...
        self.assertIn("OfficeBeats 2:00 PM", note_text)
