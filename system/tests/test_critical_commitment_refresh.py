        ...
        (root / "5. Trackers" / "TASK_MASTER.md").write_text(
            "\n".join(
                [
                    ...
                    "|:---|:-----|:------|:----|:-------|",
                    "| [PARU-001](tasks/PARU-001.md) | Ordinary stale internal cleanup | Owner | 2026-01-01 | Active |",
                    "| [PARU-002](tasks/PARU-002.md) | Manager requested readiness by 2026-07-10 | Owner | 2026-07-10 | Active |",
                ]
            ),
            encoding="utf-8",
        )
